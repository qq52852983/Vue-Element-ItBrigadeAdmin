...
<script>
  ...
  export default {
    ...
    methods: {
      value (val) {
        this.form.Spend_time.end=this.form.Spend_time.end_place=this.form.Spend_time.on=this.form.Spend_time.on_place=''
      ...
      sub () {
        ...
        axios_get("api_Aircraft_Insert", this.form, (result) => {
          console.log(result)
