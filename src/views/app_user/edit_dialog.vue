...
<script>
import {axios_get,axios_post} from "@/common/axios";
  ...
  export default {
    ...
    methods: {
      ...
      value (val) {
        ...
        this.form.Cell=val.Cell
        this.form.Location=val.Location.split(',')
        this.form.Head_Base64=val.Head_Base64
        this.form.Remarks=val.Remarks
        this.form.Nickname=val.Nickname
        this.form.Birthday=new Date(val.Birthday)
        this.form._id=val._id
        this.dynamicTags=val.Hobby.split(',')
      ...
      sub(){
        ...
        axios_post("api_User_Updata", this.form, (result) => {
